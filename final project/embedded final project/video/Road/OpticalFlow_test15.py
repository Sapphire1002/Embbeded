        ...
        if (mag > 3) : #強度大於自訂範圍
            if (x1 != x2) and (y1 != y2) : #解聯立方程式(不能有無解和無窮多解)
                ...
                if (70 > F1 > -70): #範圍裡
                    ...
                    if (yellow_R+15> im_5R >yellow_R-15) and (yellow_G+15> im_5G >yellow_G-15) and (yellow_B+5> im_5B >yellow_B-5) : #yellowline
                        Eis[y1][x1] = 255
                    # -----------------------------------------
            else :
                Eis[y1][x1] = 0
...
path_test = 'D:\\Special_topic_project\\Project\\N04-TestReport\\EDIT_video\\Edit_video_4.mp4'
...
# videoWriter = cv2.VideoWriter('dist_Foe_5_A.mp4',fourcc,30,(width,height),False) #黑白用
videoWriter = cv2.VideoWriter('D:\\Special_topic_project\\Project\\dist_Foe_6.mp4',fourcc,30,(width,height)) #RGB用
# -----------------------------------------------------------
